...
import com.example.demo.models.LicenseDTOMobile;
...
public class LicenseController {
	...
	public ResponseEntity<List<LicenseDTOMobile>> getList()  {
//		logger.debug("LicenseServiceController getList Correlation id: {}", UserContextHolder.getContext().getCorrelationId());
		...
		List<LicenseDTOMobile> modelsDTO = new ArrayList<>();
